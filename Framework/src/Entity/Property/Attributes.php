...
trait Attributes {
  ...
  public function attribute(string $attribute): string {
    return $this->attributes[mb_strtolower($attribute)];
  }
  ...
  public function hasAttribute(string $attribute): bool {
    return array_key_exists(mb_strtolower($attribute), $this->attributes);
  }
  ...
  public function unsetAttributes(array $attributes = NULL): void {
    ...
    if (!isset($attributes)) {
      ...
      foreach ($attributes as $attribute) {
        unset($this->attributes[mb_strtolower($attribute)]);
      }
    }
  }
